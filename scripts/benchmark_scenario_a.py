...
def main():
    ...
    parser.add_argument("--strategies", default="greedy,integrated,random_lns,alns")
    parser.add_argument("--initialization", default="greedy_hint", choices=("direct", "feasibility", "greedy_hint"))
