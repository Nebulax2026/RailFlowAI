...
The official validator executable is not available locally. The strict weekly-closure policy and scoring formula were updated from official feedback and protected with regression tests. A and B replacement outputs are officially accepted. C=122.4 is a strict-model candidate pending official validation.
